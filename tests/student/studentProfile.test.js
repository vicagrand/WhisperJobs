...
beforeEach(() => {
  ...
  <input id="forHire" placeholder = "yes" value = "yes">
...
it('Should display the user details on the screen', () => {
  ...
  let location = arr_students[0].location;
  document.getElementById("location").placeholder = `${location}`;
  let username = arr_students[0].username;
  document.getElementById("email").innerHTML += `${username}`;
  let education = arr_students[0].education;
